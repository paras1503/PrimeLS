...
const Consultation =()=>{
      return (<>
        ...
        <Heading pb="1.563rem" className="fadein revealOnce" fontFamily="avenir" fontSize="2.125rem" textAlign="center">OUR EXPERTISE, OUR PROSPERITY</Heading>
        <Flex> 
            <Text className="fadein-2sdelay revealOnce" fontSize="1rem" textAlign="left">
