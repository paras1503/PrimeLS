...
const Ourclients =()=>{
  ...
  const settings = {
    ...
    return (<>
        <Flex w="100%" ref={ref} direction="column" h="100%"overflow="hidden"  px="1rem" pb="1.875rem">
        <Text zIndex="5" bgColor="inherit" mt="-1.875rem" pt="1.875rem" textAlign="center" pb="1.563rem" className="slidein-top revealOnce" fontFamily="goudy" fontSize="2.125rem">HIGHER RENTALS IN RESIDENTIAL PROPERTIES</Text>
        <Flex direction="column" w="100%" overflow="hidden">
        
            <Flex direction="column" w="100%">
            <Heading textAlign="center" fontFamily="avenir" pb="1.563rem" fontSize="1.5rem" className="fadein-2sdelay revealOnce">CHENNAI’S HIGHEST 
            RENTAL INCOME PROPERTY</Heading>
            <Text textAlign="center" pb="1.563rem" fontFamily="varela round" fontSize="1rem" className="fadein-2sdelay revealOnce">The real estate sector around the world functions on the principle that the rental value of the property determines the end value or purchase value of the property. In countries like Dubai Rental Rates varies from 4 to 6%, UK, Singapore Rental Rates are 2 to 3% of the property value. The FD rates in these countries are ± 1% of rental return. But in India the residential sector fetches rental returns of just 2% of the property value as compared to FD rates which are around 6%.
              <br/><br/>
