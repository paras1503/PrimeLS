...
return (
    ...
    bgSize="cover">
        ...
        <Flex mt="1.125rem" direction="column" h="100%" w="100%" overflow="hidden">
        <SimpleGrid
        px="1rem"
        columns={3}
        w="100%"
        overflow="hidden"
        spacing=".312rem">
            <GridItem pos="relative" w="100%" h="225px" rowSpan={2} className="image-slieddown reveal">
            <Image
            h="100%" w="100%"
            src={manage}
            />
            ...
            <Image
                            ...
                            <GridItem pos="relative" w="226px" h="110px" colSpan={2} className="image-sliedright reveal">
                            <Image
                            w="100%"
                            h="100%"
                             src={cons}
                            ...
                            <GridItem pos="relative" w="110px" h="110px" className="fadein reveal">
                            <Image
                            h="100%" w="100%"
                             src={joint}
                                />
