...
const BoardofDirectors =()=>{
    ...
    return (<>
        ...
        <Center textAlign="center" pb="1.875rem" className="slidein-top revealOnce" fontFamily="goudy" fontSize="2.125rem">BOARD OF DIRECTORS</Center>
        <Flex direction="column" w="100%">
            <Flex direction="column" w="100%">
            <Text textAlign="center" fontFamily="goudy" pb=".625rem" fontSize="1.5rem" className="fadein-2sdelay revealOnce">MR. RAJEEV AJMERA</Text>
            <Heading textAlign="center" fontFamily="avenir" pb="1rem" fontSize="1.125rem" className="fadein-2sdelay revealOnce">CHAIRMAN & MANAGING<br/>DIRECTOR</Heading>
            <Image boxShadow="2xl" mb="1.563rem" className="fadein reveal" src={rajeev} w="100%" h="18.75rem" alt="IMAGE"/>
        ...
        <Flex direction="column" gap="3.125rem" overflow="hidden" pt="3.125rem" pb="3.125rem">
            <Flex direction="column" w="100%">
                <Heading textAlign="center" fontFamily="avenir" pb=".625rem" fontSize="1.5rem">MR. PUNIT CHOPRA</Heading>
                <Heading textAlign="center" fontFamily="varela round" pb="1rem" fontSize="1.125rem">Director</Heading>
                <Flex overflow="hidden">
                    <Image mb="1.563rem" boxShadow="xl" src={punit} w="100%" h="18.75rem" className="image-slieddown reveal"/>
                </Flex>
                <Text textAlign="center" fontFamily="varela round" fontSize="1rem">
            ...
            <Flex direction="column" w="100%">
                <Heading textAlign="center" fontFamily="avenir" pb=".625rem" fontSize="1.5rem">MR. ARVINND AGARWAL</Heading>
                <Heading textAlign="center" fontFamily="varela round" pb="1rem" fontSize="1.125rem">Director</Heading>
                <Flex overflow="hidden">
                    <Image mb="1.563rem" boxShadow="xl" src={arvinnd} w="100%" h="18.75rem" className="image-slieddown reveal"/>
                </Flex>
                <Text textAlign="center" fontFamily="varela round" fontSize="1rem">
            ...
            <Flex direction="column" w="100%">
                <Heading textAlign="center" className="fadein-2sdelay revealOnce" pb=".625rem" fontFamily="avenir" fontSize="1.5rem">MR. RAJESH MANGHNANI</Heading>
                ...
                <Flex overflow="hidden">
                    <Image mb="1.563rem" boxShadow="xl" src={rajesh} w="100%" h="18.75rem" className="image-slieddown reveal"/>
                </Flex>
                <Text textAlign="center" className="fadein-2sdelay revealOnce" fontFamily="varela round" fontSize="1rem">
