...
const Whoweare =()=>{
      ...
      <Flex px="1rem" direction="column" overflow="hidden">
      
        <Flex direction="column">
        <Center pb="1.563rem"
          mt="-1.875rem" pt="1.875rem" bgImage="inherit" zIndex="5"
       ...
       <Flex direction="column" overflow="hidden" pt="1.875rem">
            <Flex direction="column" w="100%" className="fadein-2sdelay revealOnce" bgImage='linear-gradient(rgba(255,255,255,.2), rgba(255,255,255,.2)), url("/images/bg-box.jpg")'
            bgRepeat="no-repeat"
            bgPos="center"
            bgSize="cover">
            ...
            bgPos="center"
            bgSize="cover">
                <Center><Text pt="1.875rem" pb="1rem" fontFamily="goudy" fontSize="2.125rem" px="1rem">VISION</Text></Center>
                <Center><Image h="5rem" w="5rem" src={visionSvg} pb="1.125rem" /></Center>
                <Flex direction="column">
                    <Heading pb="0.625rem" fontFamily="avenir" fontSize="1.125rem" textAlign="center" px="1rem">INDIA'S MOST ADMIRED & IMPACTFUL
                    REAL ESTATE COMPANY.</Heading>
                    <Text pb="1.875rem" fontFamily="varela round" fontSize="1rem" textAlign="center">
        ...
        <Flex mt="9.375rem" direction="column" pos="relative" pb="3.125rem" bgImage='linear-gradient(rgba(255,255,255,.2), rgba(255,255,255,.2)), url("/images/bg-box.jpg")'
            ...
            bgPos="center"
            bgSize="cover">
        <Image boxShadow="2xl" mt="-6.25rem" alignSelf="center" className="expandcar reveal" src={rajeev} w="15rem" h="14rem" alt="IMAGE"/>
