...
const ModalWindwow = ({modalTitle,modalImage,isOpen,onClose}) => {
  return (
    <>
      ...
      />
      <Modal width="28.7rem" height="29.75" blockScrollOnMount={true} show={isOpen} onHide={onClose}>
          ...
          <Modal.Body>
            ...
            <Flex mt="1rem">
            <Flex w="40%" align="center" direction="column" gap="1rem" ml="0.8rem">
              <Image px="2rem" ml="14rem" mb="2rem" src="/images/logo.png"/>
            ...
            <Flex boxShadow="2xl" w="60%" p="0.5rem"  align="center" justify="center" direction="column" pb="1rem" mr="2rem"  mt="2.5rem" bgImage='linear-gradient(rgba(255,255,255,.5), rgba(255,255,255,.5)), url("/images/bg-box.jpg")'
      bgRepeat="no-repeat"
      bgPos="center"
      bgSize="cover">
              <form>
