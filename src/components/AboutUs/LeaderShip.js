...
const LeaderShip =()=>{
    ...
    return (<>
        ...
        <Flex w="100%" gap="1rem" mb="5rem">
            ...
            bgPos="center"
            bgSize="cover">
                <Image className="expandcar revealOnce" boxShadow="2xl" h="18.75rem" src={leader.img}/>
                <Text pt="1.563rem" pb="1rem" fontFamily="avenir" fontWeight="bold" textAlign="center" fontSize="1.5rem">{leader.name}</Text>
