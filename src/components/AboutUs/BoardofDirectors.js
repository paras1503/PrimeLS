    ...
    return (<>
        ...
        <Flex >
          ...
          >
            ...
            <Image opacity={0} src={rajeev} w="600px" h="400px" alt="IMAGE"/>
        ...
        <Flex gap="1.25rem" overflow="hidden" pt="2.125rem">
            <Flex direction="column" w="33%"  overflow="hidden">
                <Image src={punit} w="100%" h="350px" className="image-slieddown revealOnce"/>
          ...
          >
            ...
            <Flex direction="column" w="33%"  overflow="hidden">
                <Image src={arvinnd} w="100%" h="350px" className="image-slieddown revealOnce"/>
          ...
          >
            ...
            <Flex direction="column" w="33%" overflow="hidden">
                <Image src={rajesh} w="100%" h="350px" className="image-slieddown revealOnce"/>
